    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 text-center animated pulse">
                ...
                <h5 class="COLFont font16 ">"Alarm Management"</h5>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="dancing-script">Total Alarm {{App\Alarm::all()->count()}}</h3>
                </div>
                <div class="card-body">
                    <label for="search">Search Available on: <br>Device IMEI</label>
                    <br>
